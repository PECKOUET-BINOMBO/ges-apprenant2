...
<body>
    <div class="login-container">
        <div class="login-box">
            <img src="assets/images/logo.png" alt="Logo ODC" class="logo">
            ...
            <form action="?route=login_post" method="post">
                ...
                <input type="text" id="email" name="email" placeholder="Matricule ou email">
                <?php if (!empty($formErrors['email'])) : ?>
                    <div class="error-msg"><?= htmlspecialchars($formErrors['email']) ?></div>
                <?php endif; ?>

                <label for="password">Mot de passe</label>
                <input type="password" id="password" name="password" placeholder="Mot de passe">
                <?php if (!empty($formErrors['password'])) : ?>
                    <div class="error-msg"><?= htmlspecialchars($formErrors['password']) ?></div>
                <?php endif; ?>

                <a href="?route=forgot" class="forgot">Mot de passe oublié ?</a>
